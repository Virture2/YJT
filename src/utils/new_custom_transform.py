...
class Compose(object):
    ...
    def __call__(self, images, imus, intrinsics, gnss):
        for t in self.transforms:
            images, imus, intrinsics, gnss = t(images, imus, intrinsics, gnss)
        return images, imus, intrinsics, gnss
...
class RandomColorAug(object):
    def __init__(self, augment_parameters=[0.8, 1.2, 0.5, 2.0, 0.8, 1.2], p=0.5):
        self.gamma_low = augment_parameters[0]
        self.gamma_high = augment_parameters[1]
        self.brightness_low = augment_parameters[2]
        self.brightness_high = augment_parameters[3]
        self.color_low = augment_parameters[4]
        self.color_high = augment_parameters[5]
        self.p = p
